...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/bitter-recipe-0403)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-recipe-0403
```

A live public deployment of this template is available at [https://bitter-recipe-0403.templates.workers.dev](https://bitter-recipe-0403.templates.workers.dev)
